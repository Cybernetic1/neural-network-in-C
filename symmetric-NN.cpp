...
// functions with random kernels.  The sum would consists of N such functions.
// The formula of the target function is:
//		f(x) = (1/N) ∑ exp(-x' A x)
// where A = kernel matrix (any random, positive-definite matrix) of the Gaussian function
